...
def make_marker(name, fixed_frame, shape, scale, ts, quat, is_dynamic, 
    ...
    int_marker.header.frame_id = "head_" + fixed_frame
...
def main():
    ...
    disable_joint_state_pub_nojsp = True
    rospy.set_param('disable_joint_state_pub_nojsp', disable_joint_state_pub_nojsp)
    if not disable_joint_state_pub_nojsp:
    ...
    print("I did a bad trick in publish_waypoints.py using init_pos")
