...
#     replay_trigger = rospy.ServiceProxy('/moveit_replay_trajectory/trigger', Empty)c
  ...
  rospy.logwarn("[Experiment] Waiting for everything to initialize...")
  rospy.sleep(wait_for_init)
  rospy.loginfo("[Experiment] Everything is initialized!")
  ...
  rospy.logwarn("[Experiment] Waiting for the solver to move the robot to the initial pose...")
